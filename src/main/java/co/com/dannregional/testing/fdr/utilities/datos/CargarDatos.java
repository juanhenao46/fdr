package co.com.dannregional.testing.fdr.utilities.datos;
...
public class CargarDatos implements Task {
  private static final Logger LOGGER = LogManager.getLogger(co.com.dannregional.testing.fdr.utilities.datos.CargarDatos.class.getName());
