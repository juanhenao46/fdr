...
public class FiltrarOperacionPagosTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                Click.on(BTN_OPCION_PAGOS),
                esperarEnSegundos(2000)
        );
    }
    public static FiltrarOperacionPagosTask filtrarOperacionPagos() {
        return instrumented(FiltrarOperacionPagosTask.class);
    }
}
