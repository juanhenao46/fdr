package co.com.dannregional.testing.fdr.utilities.runner;
 ...
 *  @sice 01/11/2019
 * */
public class RunnerDannRegional extends Runner {
  private static final Logger LOGGER = LogManager.getLogger(RunnerDannRegional.class.getName());
  private Class<CucumberWithSerenity> classValue;
  private CucumberWithSerenity cucumberWithSerenity;

  public RunnerDannRegional(Class<CucumberWithSerenity> classValue)
