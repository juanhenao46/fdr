...
public class ActivarNotificacionTask implements Task {
    ...
    public static ActivarNotificacionTask activarNotificacion() {
        return instrumented(ActivarNotificacionTask.class);
    }
}
