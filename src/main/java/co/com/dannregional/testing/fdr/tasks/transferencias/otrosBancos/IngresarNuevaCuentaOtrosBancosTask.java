...
public class IngresarNuevaCuentaOtrosBancosTask implements Task {
    ...
    public static IngresarNuevaCuentaOtrosBancosTask ingresarNuevaCuentaOtrosBancos() {
        return instrumented(IngresarNuevaCuentaOtrosBancosTask.class);
    }
}
