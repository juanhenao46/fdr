...
public class EliminarProgramacionTask implements Task {

    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                esperarEnSegundos(1000),
                Click.on(BTN_ELIMINAR_PROGRAMACION),
                esperarEnSegundos(1000),
    ...
    public static EliminarProgramacionTask eliminarProgramacion() {
        return instrumented(EliminarProgramacionTask.class);
    }
}
