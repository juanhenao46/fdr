# language: es
@E2E_iris
Característica: Aplicativo Banco IRIS Autorizaciones pendientes eliminar transaccion desde el modal de detalle
  El usuario debe tener la habilidad para eliminar una transaccion desde el modal de detalle
  @TestCase1
  Esquema del escenario: Eliminar autorizacion desde el modal
