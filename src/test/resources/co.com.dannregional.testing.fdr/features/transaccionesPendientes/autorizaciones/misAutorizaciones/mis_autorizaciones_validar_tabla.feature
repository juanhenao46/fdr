# language: es
@E2E_iris
Característica: Aplicativo Banco IRIS Mis autorizaciones validar tabla con informacion
  El usuario debe tener la habilidad para validar tabla con informacion de mis autorizacion
  @TestCase1
  Esquema del escenario: Tabla con informacion mis autorizaciones
