...
Característica: Aplicativo Banco IRIS Transferencias a cuentas propias
  El usuario debe tener la habilidad para programar una transferencia a una cuenta de otros bancos
  @TestCase1
  Esquema del escenario: Programar transferencia a otros bancos exitosa
