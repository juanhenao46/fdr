...
Característica: Aplicativo Banco IRIS Transferencias a Otros bancos
  ...
  @TestCase1
  Esquema del escenario: Transferencia a otros bancos pendiente de aprobacion
    ...
    Ejemplos:
      | nit | usuario | clave | cuenta origen | banco destino | cuenta destino | valor |
          ##@externaldata@./src/test/resources/co.com.dannregional.testing.fdr/datadriver/transferencias/otrosBancos/TransferenciasOtrosBancosAprobacion.xlsx@Datos
	|111111103|operador2automation3|juanfelipehenaolopez|QANueva ••••0870|Banco AV Villas|QA AV VILLAS ••••4564|1500000|
