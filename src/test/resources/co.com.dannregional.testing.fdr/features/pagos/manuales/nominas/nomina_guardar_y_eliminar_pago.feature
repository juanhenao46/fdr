# language: es
@E2E_iris
Característica: Aplicativo Banco IRIS Pago de nominas guardar y eliminar pago
  El usuario debe tener la habilidad para guardar y eliminar un pago de nominas
  @TestCase1
  Esquema del escenario: Guardar y eliminar un pago de nominas
