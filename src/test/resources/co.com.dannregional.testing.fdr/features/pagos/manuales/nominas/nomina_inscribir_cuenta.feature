...
Característica: Aplicativo Banco IRIS Pago de nominas
  El usuario debe tener la habilidad para realizar un pago a otros bancos e inscribir la cuenta
  @TestCase1
  Esquema del escenario: Pago de nominas otros bancos inscribir nueva cuenta
