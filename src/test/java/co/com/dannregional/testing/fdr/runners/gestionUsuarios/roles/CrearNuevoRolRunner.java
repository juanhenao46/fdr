...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/gestionUsuarios/roles/crear_nuevo_rol.feature",
...
public class CrearNuevoRolRunner {

    public CrearNuevoRolRunner() {
    }
