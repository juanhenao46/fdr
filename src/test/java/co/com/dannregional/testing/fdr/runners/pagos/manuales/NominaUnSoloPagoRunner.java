...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/pagos/manuales/nominas/nomina_un_solo_pago.feature",
...
public class NominaUnSoloPagoRunner {
    public NominaUnSoloPagoRunner() {
    }
    @BeforeRunner
