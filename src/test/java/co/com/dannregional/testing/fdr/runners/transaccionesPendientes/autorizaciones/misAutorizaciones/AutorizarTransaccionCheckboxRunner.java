...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/transaccionesPendientes/autorizaciones/misAutorizaciones/mis_autorizaciones_checkbox_autorizar.feature",
...
public class AutorizarTransaccionCheckboxRunner {
    public AutorizarTransaccionCheckboxRunner() {
    }
    @BeforeRunner
