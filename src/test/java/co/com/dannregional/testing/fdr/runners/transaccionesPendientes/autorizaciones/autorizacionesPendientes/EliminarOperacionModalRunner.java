...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/transaccionesPendientes/autorizaciones/autorizacionesPendientes/autorizaciones_pendientes_modal_eliminar.feature",
...
public class EliminarOperacionModalRunner {
    public EliminarOperacionModalRunner() {
    }
    @BeforeRunner
