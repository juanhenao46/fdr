package co.com.dannregional.testing.fdr.runners.historicoTransacciones.transacciones;
...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/historicoTransacciones/transacciones/historico_transacciones_validar_filtro.feature",
...
public class ValidarFiltroHistoricoTransaccionesRunner {
    public ValidarFiltroHistoricoTransaccionesRunner() {
    }
    @BeforeRunner
    public static void test() throws InvalidFormatException, IOException {
        DatosFeature.overrideFeatureFiles(
                "./src/test/resources/co.com.dannregional.testing.fdr/features/historicoTransacciones/transacciones");
    }
}
