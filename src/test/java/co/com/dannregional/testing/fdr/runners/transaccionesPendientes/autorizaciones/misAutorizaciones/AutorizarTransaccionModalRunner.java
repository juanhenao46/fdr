...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/transaccionesPendientes/autorizaciones/misAutorizaciones/mis_autorizaciones_modal_autorizar.feature",
...
public class AutorizarTransaccionModalRunner {
    public AutorizarTransaccionModalRunner() {
    }
    @BeforeRunner
