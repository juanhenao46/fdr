...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/pagos/manuales/proveedores/proveedores_dos_pagos.feature",
...
public class ProveedoresDosPagosRunner {
    public ProveedoresDosPagosRunner() {
    }
    @BeforeRunner
