...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/pagos/manuales/nominas/nomina_inscribir_cuenta.feature",
...
public class NominaNuevaCuentaOtrosBancosRunner {
    public NominaNuevaCuentaOtrosBancosRunner() {
    }
    @BeforeRunner
