...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/pagos/manuales/proveedores/proveedores_un_solo_pago.feature",
...
public class ProveedoresUnSoloPagoRunner {
    public ProveedoresUnSoloPagoRunner() {
    }
    @BeforeRunner
