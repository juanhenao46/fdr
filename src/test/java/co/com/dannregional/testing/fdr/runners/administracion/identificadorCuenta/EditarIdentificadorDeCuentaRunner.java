package co.com.dannregional.testing.fdr.runners.administracion.identificadorCuenta;
...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/administracion/identificadorCuenta/editar_identificador_de_cuenta.feature",
        ...
        glue = {"co.com.dannregional.testing.fdr.stepdefinitions.autentificacion.logueo",
                ...
                "co.com.dannregional.testing.fdr.stepdefinitions.administracion.identificadorCuenta",
...
public class EditarIdentificadorDeCuentaRunner {

    public EditarIdentificadorDeCuentaRunner() {
    }

    @BeforeRunner
    public static void test() throws InvalidFormatException, IOException {
        DatosFeature.overrideFeatureFiles(
                "./src/test/resources/co.com.dannregional.testing.fdr/features/administracion/identificadorCuenta");
    }
}
