...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/transferencias/cuentasIris/realizar_transferencia_cuentas_iris_programada.feature",
...
public class TransferenciaProgramadaCuentasIrisRunner {
    public TransferenciaProgramadaCuentasIrisRunner() {
    }
    @BeforeRunner
