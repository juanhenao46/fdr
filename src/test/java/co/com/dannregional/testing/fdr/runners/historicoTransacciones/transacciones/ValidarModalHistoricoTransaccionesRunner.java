...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/historicoTransacciones/transacciones/historico_transacciones_validar_modal.feature",
...
public class ValidarModalHistoricoTransaccionesRunner {
    public ValidarModalHistoricoTransaccionesRunner() {
    }
    @BeforeRunner
