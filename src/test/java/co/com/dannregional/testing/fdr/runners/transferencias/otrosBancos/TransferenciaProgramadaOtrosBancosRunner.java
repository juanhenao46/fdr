...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/transferencias/otrosBancos/realizar_transferencia_otros_bancos_programada.feature",
...
public class TransferenciaProgramadaOtrosBancosRunner {
    public TransferenciaProgramadaOtrosBancosRunner() {
    }
    @BeforeRunner
