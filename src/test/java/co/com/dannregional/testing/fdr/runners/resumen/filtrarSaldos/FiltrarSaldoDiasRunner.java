...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/resumen/filtrarPorDias/filtrar_saldos_por_dias.feature",
...
public class FiltrarSaldoDiasRunner {
    public FiltrarSaldoDiasRunner(){

    }
    @BeforeRunner
    public static void test() throws InvalidFormatException, IOException {
        DatosFeature.overrideFeatureFiles(
                "./src/test/resources/co.com.dannregional.testing.fdr/features/resumen/filtrarPorDias");
    }
}
