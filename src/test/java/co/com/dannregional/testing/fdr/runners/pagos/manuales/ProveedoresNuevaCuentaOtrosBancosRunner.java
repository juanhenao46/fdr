...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/pagos/manuales/proveedores/proveedores_inscribir_cuenta.feature",
...
public class ProveedoresNuevaCuentaOtrosBancosRunner {
    public ProveedoresNuevaCuentaOtrosBancosRunner() {
    }
    @BeforeRunner
