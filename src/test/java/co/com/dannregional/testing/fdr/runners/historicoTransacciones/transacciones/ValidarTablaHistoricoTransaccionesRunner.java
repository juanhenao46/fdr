...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/historicoTransacciones/transacciones/historico_transacciones_validar_tabla.feature",
...
public class ValidarTablaHistoricoTransaccionesRunner {
    public ValidarTablaHistoricoTransaccionesRunner() {
    }
    @BeforeRunner
