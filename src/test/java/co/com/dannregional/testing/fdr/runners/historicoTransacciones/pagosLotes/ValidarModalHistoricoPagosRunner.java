...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/historicoTransacciones/pagosLotes/historico_pagos_lotes_validar_modal.feature",
...
public class ValidarModalHistoricoPagosRunner {
    public ValidarModalHistoricoPagosRunner() {
    }
    @BeforeRunner
