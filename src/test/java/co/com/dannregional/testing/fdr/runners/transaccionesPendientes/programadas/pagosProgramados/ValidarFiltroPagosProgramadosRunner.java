...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/transaccionesPendientes/programadas/pagos/pagos_programados_validar_filtro.feature",
...
public class ValidarFiltroPagosProgramadosRunner {
    public ValidarFiltroPagosProgramadosRunner() {
    }
    @BeforeRunner
