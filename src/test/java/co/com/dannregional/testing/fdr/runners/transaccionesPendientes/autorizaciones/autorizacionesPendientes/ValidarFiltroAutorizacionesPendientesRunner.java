...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/transaccionesPendientes/autorizaciones/autorizacionesPendientes/autorizaciones_pendientes_validar_filtro.feature",
...
public class ValidarFiltroAutorizacionesPendientesRunner {
    public ValidarFiltroAutorizacionesPendientesRunner() {
    }
    @BeforeRunner
