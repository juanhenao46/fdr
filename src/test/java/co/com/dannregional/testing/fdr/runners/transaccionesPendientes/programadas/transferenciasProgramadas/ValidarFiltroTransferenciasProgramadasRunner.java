...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/transaccionesPendientes/programadas/transferencias/transferencias_programadas_validar_filtro.feature",
...
public class ValidarFiltroTransferenciasProgramadasRunner {
    public ValidarFiltroTransferenciasProgramadasRunner() {
    }
    @BeforeRunner
