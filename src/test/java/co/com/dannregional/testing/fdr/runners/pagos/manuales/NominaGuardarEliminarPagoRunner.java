...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/pagos/manuales/nominas/nomina_guardar_y_eliminar_pago.feature",
...
public class NominaGuardarEliminarPagoRunner {
    public NominaGuardarEliminarPagoRunner() {
    }
    @BeforeRunner
