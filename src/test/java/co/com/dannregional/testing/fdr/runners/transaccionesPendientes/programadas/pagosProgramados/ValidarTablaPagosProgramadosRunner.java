...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/transaccionesPendientes/programadas/pagos/pagos_programados_validar_tabla.feature",
...
public class ValidarTablaPagosProgramadosRunner {
    public ValidarTablaPagosProgramadosRunner() {
    }
    @BeforeRunner
