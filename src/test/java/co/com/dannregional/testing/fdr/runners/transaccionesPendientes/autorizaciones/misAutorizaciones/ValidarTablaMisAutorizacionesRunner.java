...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/transaccionesPendientes/autorizaciones/misAutorizaciones/mis_autorizaciones_validar_tabla.feature",
...
public class ValidarTablaMisAutorizacionesRunner {
    public ValidarTablaMisAutorizacionesRunner() {
    }
    @BeforeRunner
