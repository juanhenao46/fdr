...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/pagos/manuales/proveedores/proveedores_guardar_y_eliminar_pago.feature",
...
public class ProveedoresGuardarEliminarPagoRunner {
    public ProveedoresGuardarEliminarPagoRunner() {
    }
    @BeforeRunner
    public static void test() throws InvalidFormatException, IOException {
        DatosFeature.overrideFeatureFiles(
                "./src/test/resources/co.com.dannregional.testing.fdr/features/pagos/manuales/proveedores");
    }
}
