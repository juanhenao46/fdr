...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/transaccionesPendientes/autorizaciones/autorizacionesPendientes/autorizaciones_pendientes_checkbox_eliminar.feature",
...
public class EliminarOperacionCheckboxRunner {
    public EliminarOperacionCheckboxRunner() {
    }
    @BeforeRunner
