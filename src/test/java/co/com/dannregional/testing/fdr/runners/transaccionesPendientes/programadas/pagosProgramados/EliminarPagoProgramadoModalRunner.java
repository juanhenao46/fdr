...
@CucumberOptions(
        features ="src/test/resources/co.com.dannregional.testing.fdr/features/transaccionesPendientes/programadas/pagos/pagos_programados_modal_eliminar.feature",
...
public class EliminarPagoProgramadoModalRunner {
    public EliminarPagoProgramadoModalRunner() {
    }
    @BeforeRunner
